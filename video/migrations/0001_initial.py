    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marker_type', models.CharField(choices=[('S', 'Section marker'), ('Q', 'Quiz marker')], default='Q', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invideo_quiz_file', models.FileField(blank=True, null=True, upload_to=video.models.in_video_quiz_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video_watched_duration', models.DurationField(default=datetime.timedelta(0))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=75)),
                ('marker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='video.marker')),
            ],
        ),
        migrations.CreateModel(
            name='QuizMarker',
