...
from quiz.models import (Quiz, QuestionModule, Question, QuestionHistory,
                         SingleCorrectQuestion, SingleCorrectQuestionHistory,
                         MultipleCorrectQuestion,
                         MulitpleCorrectQuestionHistory, FixedAnswerQuestion,
                         FixedCorrectQuestionHistory, DescriptiveQuestion,
...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ('id', 'quiz_module', 'question_description',
                    'answer_description')
...
class SingleCorrectQuestionHistoryAdmin(admin.ModelAdmin):
    ...
    search_fields = ('question_history__question__question_description',
                     'question_history__user__email')
...
admin.site.register(SingleCorrectQuestionHistory,
                    SingleCorrectQuestionHistoryAdmin)
admin.site.register(MultipleCorrectQuestion, MultipleCorrectQuestionAdmin)
admin.site.register(MulitpleCorrectQuestionHistory,
                    MulitpleCorrectQuestionHistoryAdmin)
admin.site.register(FixedAnswerQuestion, FixedAnswerQuestionAdmin)
admin.site.register(FixedCorrectQuestionHistory,
                    FixedCorrectQuestionHistoryAdmin)
