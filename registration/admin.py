...
class SubscriptionAdmin(admin.ModelAdmin):
    list_display = [
        'plan_type', 'no_of_courses', 'no_of_students_per_course',
        'prog_assign_enabled', 'subjective_lab_enabled', 'email_enabled',
        'per_video_limit', 'per_video_limit_unit', 'total_video_limit',
        'total_video_limit_unit', 'subjective_lab_submission_size_per_student',
