...
from .models import (Video, VideoHistory, SectionMarker, QuizMarker)


class VideoAdmin(admin.ModelAdmin):
    list_display = ('id', 'chapter', 'section', 'title', 'description',
                    'video_file', 'doc_file', 'in_video_quiz_file',
                    'video_duration', 'uploaded_on', 'modified_on')
    search_fields = ('title',)
...
class QuizMarkerAdmin(admin.ModelAdmin):
    list_display = ('id', 'video', 'time', 'title', 'quiz', 'created_on',
                    'modified_on')
    search_fields = ('video__title', 'title')
