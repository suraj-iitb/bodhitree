...
class SubjectiveAssignment(models.Model):
    ...
    files_to_be_submitted = ArrayField(models.IntegerField(),
                                       null=True,
                                       blank=True)
...
class SubjectiveAssignmentTeam(models.Model):
    ...
    subjective_assignment = models.ForeignKey(SubjectiveAssignment,
...
class SubjectiveAssignmentHistory(models.Model):
    assignment_history = models.OneToOneField(AssignmentHistory,
                                              on_delete=models.CASCADE)
    submitted_by = models.ForeignKey(settings.AUTH_USER_MODEL,
                                     on_delete=models.CASCADE)
    marks_obtained = models.FloatField()
    subjective_assignment_team = models.ForeignKey(SubjectiveAssignmentTeam,
                                                   on_delete=models.CASCADE)
