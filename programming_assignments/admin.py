...
from programming_assignments.models import (
    TAAllocation, Assignment, AssignmentHistory, SimpleProgrammingAssignment,
    SimpleProgrammingAssignmentHistory,
    SimpleProgrammingAssignmentHistoryVersion, AdvancedProgrammingAssignment,
    AdvancedProgrammingAssignmentHistory,
    AdvancedProgrammingAssignmentHistoryVersion, AssignmentSection, Testcase,
    TestcaseHistory, Exam, ExamHistory)
...
class ExamAdmin(admin.ModelAdmin):
    list_display = ('id', 'course', 'duration', 'late_duration',
                    'allowed_ip_range', 'assignment')
    search_fields = ('assignment__name',)


class ExamHistoryAdmin(admin.ModelAdmin):
    list_display = ('id', 'exam', 'user', 'ip_address', 'is_paused',
                    'is_approved', 'start_time', 'remaining_time',
                    'additional_time')
    search_fields = ('user__email',)
...
admin.site.register(SimpleProgrammingAssignment,
                    SimpleProgrammingAssignmentAdmin)
admin.site.register(SimpleProgrammingAssignmentHistory,
                    SimpleProgrammingAssignmentHistoryAdmin)
admin.site.register(SimpleProgrammingAssignmentHistoryVersion,
                    SimpleProgrammingAssignmentHistoryVersionAdmin)
admin.site.register(AdvancedProgrammingAssignment,
                    AdvancedProgrammingAssignmentAdmin)
admin.site.register(AdvancedProgrammingAssignmentHistory,
                    AdvancedProgrammingAssignmentHistoryAdmin)
admin.site.register(AdvancedProgrammingAssignmentHistoryVersion,
